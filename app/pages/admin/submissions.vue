...
const {data: submissionRequests} = await useLazyFetch<SubmissionRequest[]>("/api/submissions/requests", {
  key: "submissions-requests",
});
const {data: participants} = await useLazyFetch<ParticipantWithSubmissions[]>("/api/participants", {
